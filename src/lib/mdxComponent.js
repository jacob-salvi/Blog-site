...
export const components = {
  ...
  h2: (props) => (
    <h2 {...props} className="font-[DM_Serif_Text] text-[2.5rem] tracking-[-4%] my-6 text-[#2a2a2a] leading-none" />
  ),
  h3: (props) => (
    <h3 {...props} className="font-[Gabarito] text-[2rem] tracking-[-4%] text-[#2a2a2a] leading-none" />
  ),
  h4: (props) => (
    <h4 {...props} className="font-[DM_Serif_Text] text-[2rem] my-6 tracking-[-4%] text-[#2a2a2a] leading-none" />
  ),
  h5: (props) => (
    <h5 {...props} className="font-[Gabarito]  italic text-[1.1rem] tracking-[-4%] text-[#2a2a2a] leading-none" />
  ),
  h6: (props) => (
    <h6 {...props} className="font-[DM_Serif_Text] italic text-[1.1rem] tracking-[-4%] text-[#2a2a2a]/50 leading-none" />
  ),
  p: (props) => (
