        ...
        {/* <div 
          ...
          <div className=" Text-Illustration flex justify-between items-center px-25 py-40 relative ">
            ...
            <div className="w-auto relative z-10 -mt-10  font-gabarito font-bold text-[11vw] leading-none tracking-[-4%] text-[#FFF0B3]">
             <h1>Creative</h1>
             <p className="font-dmSerifText font-extralight italic text-2xl absolute top-[1vw] left-[9vw]">journey of being</p>
             <div className="  my-[-10] w-auto flex   justify-between text-[#FFF0B3] font-dmSerifText text-2xl italic  font-light tracking-[-6%] leading-none ">
              <h1>Human.</h1>
              <h1>Designer.</h1>
              <h1>Developer.</h1>
