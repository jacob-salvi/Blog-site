  ...
  return (
    <div className='w-[100vw] h-[100vh] flex flex-col shrink-0 justify-center items-center  '>
      <div ref={containerref} className='w-fit h-fit p-10  bg-[#fffae7]  relative'>
        <h1 ref={lineref} className='  text-[7rem] font-[DM_Serif_Text] font-normal leading-[5.5rem] tracking-[-4%] text-[#2a2a2a]'>A place to <br/>Collect my</h1>
        <div ref={wrapperRef}>
      ...
      <div className=''> 
        <h1 className='font-[DM_Serif_Text] italic text-[#2a2a2a] text-[1.2rem]'>Not a guidebook. A journal. </h1>
      </div>
