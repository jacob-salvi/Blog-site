...
const Header = ({frontmatter}) => {
  ...
  return (
    <div className=' w-full items-center mt-20 md:mt-32 '>
      <div className='flex flex-col  items-center gap-4'>
        <h1 className='text-title-md md:text-5xl'>{frontmatter.title}</h1>
       <div className=" text-default font-bold text-center ">
            <span className="font-dmSerifText italic  mr-2 text-[var(--color-text)]/50">on</span>
            {frontmatter.date}
        </div>
      </div>                                                  
    </div>
...
// old code/design
      ...
      //                           </svg>
      //                       </div>
      //                       <button  className='font-dmSerifText text-[1.5rem] italic'>Back</button>
      //                   </div>
      ...
      //                           <h1 className='text-[2.5rem] max-w-2/3 font-dmSerifText tracking-[-4%] leading-none text-[#2a2a2a]'>{frontmatter.blogname}</h1>
      ...
      //                   <div className='flex gap-1 font-gabarito font-bold capitalize tracking-[-4%] text-[#2a2a2a]'><span className='font-dmSerifText italic text-[#2a2a2a]/50 lowercase font-light'>by</span>{frontmatter.author}<span className='font-dmSerifText italic text-[#2a2a2a]/50 lowercase font-light'>on</span>{frontmatter.date}</div>
      //                   <div className='font-dmSerifText italic font-light'>{frontmatter.readtime}</div>
      //               </div>
      //           </div>
      //       </div>